...
namespace GetSlackMailAPI.SlackResponses
{
        ...
        public static SlackResponse GetResponse(string response, string responseType)
        {
            ...
            if (responseStatus.ok)
            {
                switch (responseType)
                {
                    ...
                    case "ChannelInfo":
                        return JsonConvert.DeserializeObject<ChannelInfoResponse>(response);
                    default:
    ...
    public class ChannelInfoResponse : SlackResponse
    {
